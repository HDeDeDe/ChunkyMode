...
namespace HDeMods
{
    ...
    public static class Hurricane {
        ...
        private static void AddHooks() {
            ...
            if (HurricaneOptionalMods.InfernoDownpour.Enabled) HurricaneOptionalMods.InfernoDownpour.GenerateHooks();
        }
        ...
        private static void VerifyInterloper(On.RoR2.RewiredIntegrationManager.orig_Init init) {
            ...
            AddLegacyDifficulty();
            SadomasochismWish.AddSadomasochismWish();
        ...
        private static void AddOptions() {
            ...
            HurricaneOptionalMods.RoO.AddButton("Reset to default", "Unlisted Difficulty Modifiers", HurricaneOptionalMods.RoO.ResetToDefault);
            ...
            HurricaneOptionalMods.RoO.AddButton("Reset to default", "Yapping", HurricaneOptionalMods.RoO.ResetToDefault);
            HurricaneOptionalMods.RoO.AddCheck(limitPest);
            HurricaneOptionalMods.RoO.AddFloatStep(limitPestAmount, 0f, 100f, 1f);
            HurricaneOptionalMods.RoO.AddButton("Reset to default", "Simulacrum", HurricaneOptionalMods.RoO.ResetToDefault);
        ...
        internal static void Run_onRunStartGlobal(Run run) {
            ...
            if (SadomasochismWish.Enabled) SadomasochismWish.RunStart();

            if (HurricaneRunInfo.instance.doEnemyLimitBoost && !SadomasochismWish.Enabled) {
                //Thanks Starstorm 2 :)
        ...
        public static void RecalculateStatsAPI_GetStatCoefficients(CharacterBody sender,
            ...
            ENEMYSTATS:
            if (!HurricaneRunInfo.instance.doEnemyNerfs || SadomasochismWish.Enabled) {
